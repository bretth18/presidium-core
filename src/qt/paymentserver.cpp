...
const QString BITCOIN_IPC_PREFIX("presidium:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/presidium-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/presidium-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/presidium-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start presidium: click-to-pay handler"));
        }
        else {
