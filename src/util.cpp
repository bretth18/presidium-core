...
const char * const BITCOIN_CONF_FILENAME = "presidium.conf";
const char * const BITCOIN_PID_FILENAME = "presidium.pid";
...
#else
    const char* pszModule = "presidium";
#endif
    if (pex)
        return strprintf(
