...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.presidium.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("presidiumtools.com", "dnsseed.presidiumtools.com"));
        vSeeds.push_back(CDNSSeedData("presidiumpool.org", "dnsseed.presidiumpool.org"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("presidiumtools.com", "testnet-seed.presidiumtools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.presidium.loshan.co.uk", true));
