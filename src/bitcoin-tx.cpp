...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s presidium-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  presidium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded presidium transaction") + "\n" +
              "  presidium-tx [options] -create [commands]   " + _("Create hex-encoded presidium transaction") + "\n" +
              "\n";
