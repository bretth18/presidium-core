...
void Shutdown()
{
    ...
    RenameThread("presidium-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/presidium-project/presidium>";
    const std::string URL_WEBSITE = "<https://presidium.org>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("presidium-loadblk");
    CImportingNow imp;
